...
<article class="project-item <?php echo esc_attr( $cate_id . $thumb_size ); ?>">
	<div class="projects-box">
		<figure class="projects-thumbnail overlay hover-scale <?php echo esc_attr( $args['settings']['hover_style'] ); ?>" data-src="<?php echo esc_url( $image_url ); ?>" data-sub-html="<?php the_title(); ?>">
