...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post post-box'); ?>>
    ...
    <div class="inner-post">
        ...
        <div class="entry-footer flex-middle clearfix">
            <div class="entry-meta"><?php archi_post_meta(); ?></div>
            <?php if( archi_get_option('post_socials') ) archi_socials_share(); ?>
        </div>
        <?php if( archi_get_option('author_box') ) archi_author_info_box(); ?>
        <?php if(archi_get_option('post_nav')){ archi_single_post_nav(); } ?>
        <?php if( archi_get_option('related_post') ) archi_related_posts(); ?>
    </div>
</article>
