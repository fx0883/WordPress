...
class archi_recent_news extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('OT Recent Posts', 'archi'), 

            /*Widget description*/
            array( 'description' => esc_html__( 'OT Recent Posts', 'archi' ), ) 
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Latest News', 'archi' ) : $instance['title'], $instance, $this->id_base );
    	...
    	echo htmlspecialchars_decode($args['before_title']) . $title . htmlspecialchars_decode($args['after_title']); 
            ...
            <ul class="recent-news clearfix">
                ...
                <?php
                    ...
                    $post_thumb   = get_the_post_thumbnail( $recent_post->ID, 'full' );
    ...
    // Check values
    	 ...
    	 $title = isset( $instance['title'] ) ? $instance['title'] : esc_html( 'Latest News', 'archi' );
    ...
    <p>
        <label><?php esc_html_e( 'Title:', 'archi' ); ?></label>

        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
    <p>

        <label><?php esc_html_e( 'Number of posts to show:', 'archi' ); ?></label> 
    ...
    <p>
        <label>
            ...
            <?php esc_html_e( 'Show date time', 'archi' ); ?>
        </label>
    </p>
...
function archi_wpb_recent_news() {
	register_widget( 'archi_recent_news' );
}
add_action( 'widgets_init', 'archi_wpb_recent_news' );