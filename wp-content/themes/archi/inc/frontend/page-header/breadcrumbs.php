<?php
// Breadcrumbs
if ( ! function_exists( 'archi_get_breadcrumbs' ) ) {
    function archi_get_breadcrumbs ( 
        $list_style = 'ul', 
        $list_id = 'breadcrumbs', 
        ...
        if ( is_tax() ) {
            ...
            foreach ( $attached_to as $post_type ) {
                ...
                if ( ! $output && get_post_type_archive_link( $cpt_obj->name ) ) {
                    $archive_link = '';
                    if ( 'ot_portfolio' == get_post_type() && archi_get_option('portfolio_archive') == 'archive_custom' ) {
                        $archive_link = get_page_link( archi_get_option('archive_page_custom') );                                
                    } else {
...
if ( ! function_exists( 'archi_breadcrumbs' ) ) {
    function archi_breadcrumbs (){
        ...
        if( archi_get_option('breadcrumbs') && !is_front_page() ){ echo archi_get_breadcrumbs(); } ?>
